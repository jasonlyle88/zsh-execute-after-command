...
# Internal settings
zstyle ':execute-after-command:internal:setting:*'  'plugin-directory'  "${0:h}"
# zstyle ':execute-after-command:internal:runtime:*'  'last-command-start-time'
# zstyle ':execute-after-command:internal:runtime:*'  'last-typed-command'
# zstyle ':execute-after-command:internal:runtime:*'  'last-executed-command'
# zstyle ':execute-after-command:internal:runtime:*'  'last-command-window-id'

source "${0:h}/lib/main.zsh"
...
function zsh-execute-after-command-preexec-hook() {
    ...
    zstyle ':execute-after-command:internal:runtime:*'  'last-command-as-executed'  "${3}"
}
...
function zsh-execute-after-command-precmd-hook() {
    ...
    zstyle -s ':execute-after-command:internal:runtime:*'   'last-command-as-executed'  'lastCommandAsExecuted'
    ...
    zstyle -d ':execute-after-command:internal:runtime:*'   'last-command-as-executed'
}
